...
import pachet.clasefilter.emil.StatieCalcatFilter;
...
public class PanelStatiiDeCalcat extends JPanel {
	...
	private void adaugaButoaneImportExport() {
		...
		btnImport.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (option == JFileChooser.APPROVE_OPTION) {
					File file = jFileChooser.getSelectedFile();
					ArrayList<StatieCalcat> lista = GUI.deserialize(file, new StatieCalcat());
					if (lista != null) {
	...
	private void adaugaGenerarea() {
		JLabel labelGenerare = new JLabel("Nr. stati de calcat:");
