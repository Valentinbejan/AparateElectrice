...
public class GeneratorMonitor {
    ...
    static private String[] numeProdusMonitor = new String[]{"Monitor LCD","Monitor LED","Monitor OLED","Monitor QLED"};
	...
	static private String[] formatEcranMonitor = new String[]{"clasic","ultraWide","Wide"};
        static private String[] rezolutieOptimaMonitor = new String[]{"1280 x 720","1920 x 1080","2560 x 1440","3840 x 2160"};
	...
	public static ArrayList<Monitor> genereazaRandomMonitor(int n){
		...
		for (double i=0;i<n;i++) {
                        ...
                        double diagonala = listrataRefresh.get(randomizer2.nextInt(listdiagonala.size()));
			 ...
			 unMonitor=new Monitor(numeProdus,producator,pret,culoare,putereConsumata,rataRefresh,diagonala,formatEcran,rezolutieOptima,timpRaspuns,functiiSpeciale);
