...
public class GeneratorMasinaSpalatVase {
    ...
    static private String[] numeProdusMasinaSpalatVase = new String[]{"Masina de spalat vase compacta","Masina de spalat vase standard"};
   
    static private String[] producatorMasinaSpalatVase = new String[]{"BOSCH","Candy","Electrolux","BEKO","Hansa","Miele"};
 
    static private double pret;
    static private int minpret = 500;  
    static private int maxpret = 5000;  
   
    static private String[] culoareMasinaSpalatVase = new String[]{"alb","negru","verde","albastru","rosu","galben"};
	...
	public static ArrayList<MasinaSpalatVase> genereazaRandomMasinaSpalatVase(int n){
		...
		for (double i=0;i<n;i++) {
			...
			int numarSeturi = new Random().nextInt(100);
			 ...
			 unMasinaSpalatVase=new MasinaSpalatVase(numeProdus,producator,pret,culoare,putereConsumata,numarSeturi,latimeCuva);
