...
public class GeneratorFierCalcat {
    ...
    static private String[] numeProdusFierCalcat = new String[]{"Fier Calcat vertical","Fier de Calcat orizontal","Fier de Calcat cu abur","Fier de Calcat mini"};
    
    static private String[] producatorFierCalcat = new String[]{"Tefal","Hausberg","Philips","Zilian","Braun","OEM"};
	...
	public static ArrayList<FierCalcat> genereazaRandomFierCalcat(int n){
		...
		for (double i=0;i<n;i++) {
			...
			String talpa = talpi[new Random().nextInt(talpi.length)];
			 ...
			 unFierCalcat=new FierCalcat(numeProdus,producator,pret,culoare,putereConsumata,talpa,latime,lungime,adancime,lungimeCablu,greutate,debitAbur,functii);
