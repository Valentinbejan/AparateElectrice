...
public class GeneratorAerConditionat {
	...
	static private String[] numeProdusAerConditionat = new String[] { "Aparate de aer conditionat de tip split",
			" Aparate de aer conditionat de tip duct", "Aparate de aer conditionat de tip caseta",
			"Aparatele de aer conditionat mobile" };

	static private String[] producatorAerConditionat = new String[] { "Vivax", "Daikin", "Hitachi", "Gree", "MDV",
			"LG" };
	...
	public static ArrayList<AerConditionat> genereazaRandomAerConditionat(int n) {
		...
		for (double i = 0; i < n; i++) {
			...
			unAerConditionat = new AerConditionat(numeProdus, producator, pret, culoare, putereConsumata, clasa,
					arieAcoperita, consumTelecomanda);
